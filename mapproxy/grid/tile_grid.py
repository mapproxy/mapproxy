...
class TileGrid(object):
    ...
    def get_affected_tiles(self, bbox, size, req_srs=None) -> tuple[BBOX, tuple[int, int], list[TileCoord]]:
        """
    ...
    def get_affected_level_tiles(self, bbox, level) -> tuple[BBOX, tuple[int, int], list[TileCoord]]:
        """
