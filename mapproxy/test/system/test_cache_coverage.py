...
class TestCacheCoverage(SysTest):
    ...
    def test_tms_capabilities_coverage(self, app):
        ...
        assert "http://localhost/tms/1.0.0/bbox_coverage_cache/EPSG4326" in resp
        assert "http://localhost/tms/1.0.0/intersection_coverage_cache/EPSG4326" in resp
    ...
    def test_wmts_capabilities_coverage(self, app):
        ...
        ) == set(["51.0 58.0", "-78.11791218081675 36.17088587412222", "50 50"])
    ...
    def test_wms_capabilities_coverage(self, app):
        ...
        assert xml.xpath("//Layer/Layer/LatLonBoundingBox/@minx") == ["-50", "-48.0", "-85.56451604106776"]
        assert xml.xpath("//Layer/Layer/LatLonBoundingBox/@miny") == ["-50", "-56.0", "25.08"]
        assert xml.xpath("//Layer/Layer/LatLonBoundingBox/@maxx") == ["50", "51.0", "-78.11791218081675"]
        assert xml.xpath("//Layer/Layer/LatLonBoundingBox/@maxy") == ["50", "58.0", "36.17088587412222"]
